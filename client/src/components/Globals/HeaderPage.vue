...
<template>
  ...
  <v-app>
    ...
    <v-app-bar
      ...
      color="white"
      dark
      src="https://images.unsplash.com/photo-1475359524104-d101d02a042b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1294&q=80"
      prominent
    >
...
export default {
  ...
  data: () => ({
    ...
    items: [
      ...
      { title: "Search", icon: "mdi-music", to: "/songs" }, 
